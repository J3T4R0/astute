...
var i_28187 = (0);
while(true){
if((i_28187 < arr.length)){
(arr[i_28187] = null);

var G__28188 = (i_28187 + (1));
i_28187 = G__28188;
continue;
} else {
}
...
var i_28203 = (self__.level + (1));
while(true){
if((i_28203 <= (new_level + (1)))){
(update[i_28203] = self__.header);

var G__28204 = (i_28203 + (1));
i_28203 = G__28204;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_28207 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_28207[i]));
} else {
x__$2.forward.push((((i < links_28207.length))?(links_28207[i]):null));
}

if((i < links_28207.length)){
(links_28207[i] = x__$2);
} else {
links_28207.push(x__$2);
}
...
var i_28210 = (0);
while(true){
if((i_28210 <= self__.level)){
var links_28211 = (update[i_28210]).forward;
if((x__$1 === (((i_28210 < links_28211.length))?(links_28211[i_28210]):null))){
(links_28211[i_28210] = (x__$1.forward[i_28210]));

var G__28212 = (i_28210 + (1));
i_28210 = G__28212;
continue;
} else {
var G__28214 = (i_28210 + (1));
i_28210 = G__28214;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__28221 = nx;
var G__28222 = (level__$1 - (1));
x = G__28221;
level__$1 = G__28222;
continue;
} else {
var G__28223 = x;
var G__28224 = (level__$1 - (1));
x = G__28223;
level__$1 = G__28224;
continue;
}
