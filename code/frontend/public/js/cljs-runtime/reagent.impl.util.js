...
var vec__35979 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str,/-/);
...
var start = first__35981;
var parts = seq__35980__$1;
...
var self__ = this;
var self__ = this;
var G__35988 = (arguments.length - (1));
switch (G__35988) {
case (0):
...
(reagent.impl.util.PartialFn.prototype.apply = (function (self__,args35987){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args35987)));
}));
...
var _STAR_always_update_STAR__orig_val__36031 = reagent.impl.util._STAR_always_update_STAR_;
var _STAR_always_update_STAR__temp_val__36032 = true;
(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__temp_val__36032);

try{return (comp["forceUpdate"])();
}finally {(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__orig_val__36031);
}} else {
