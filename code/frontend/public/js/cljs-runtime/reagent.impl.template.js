...
var G__36455 = o;
(G__36455[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__36482__delegate = function (args){
...
while (G__36483__i < G__36483__a.length) {G__36483__a[G__36483__i] = arguments[G__36483__i + 0]; ++G__36483__i;}
  args = new cljs.core.IndexedSeq(G__36483__a,0,null);
} 
return G__36482__delegate.call(this,args);};
G__36482.cljs$lang$maxFixedArity = 0;
G__36482.cljs$lang$applyTo = (function (arglist__36484){
var args = cljs.core.seq(arglist__36484);
return G__36482__delegate(args);
});
...
var G__36456 = o;
(G__36456[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__36485__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__36486__i < G__36486__a.length) {G__36486__a[G__36486__i] = arguments[G__36486__i + 0]; ++G__36486__i;}
  args = new cljs.core.IndexedSeq(G__36486__a,0,null);
} 
return G__36485__delegate.call(this,args);};
G__36485.cljs$lang$maxFixedArity = 0;
G__36485.cljs$lang$applyTo = (function (arglist__36487){
var args = cljs.core.seq(arglist__36487);
return G__36485__delegate(args);
});
...
var G__36458 = props;
var G__36458__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36458,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__36458);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36458__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__36459){
var map__36460 = p__36459;
var map__36460__$1 = cljs.core.__destructure_map(map__36460);
var props = map__36460__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36460__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__36461){
var map__36462 = p__36461;
var map__36462__$1 = cljs.core.__destructure_map(map__36462);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36462__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var G__36464 = jsprops;
(G__36464["defaultValue"] = value);

(G__36464["onChange"] = (function (p1__36463_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__36463_SHARP_);
}));
...
var vec__36466 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36466,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36466,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36466,(2),null);
...
var jsprops = ({"argv": v});
var temp__5757__auto___36495 = reagent.impl.template.key_from_vec(v);
if((temp__5757__auto___36495 == null)){
} else {
var key_36496 = temp__5757__auto___36495;
(jsprops["key"] = key_36496);
}
...
var temp__5757__auto___36497 = reagent.impl.template.key_from_vec(argv);
if((temp__5757__auto___36497 == null)){
} else {
var key_36498 = temp__5757__auto___36497;
reagent.impl.template.oset(jsprops,"key",key_36498);
}
...
var G__36470 = reagent.impl.template.__GT_NativeWrapper();
(G__36470["name"] = c);
...
var G__36471 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__36471) : reagent.impl.template.as_element.call(null,G__36471));
} else {
...
var len__4829__auto___36504 = arguments.length;
var i__4830__auto___36505 = (0);
while(true){
if((i__4830__auto___36505 < len__4829__auto___36504)){
args__4835__auto__.push((arguments[i__4830__auto___36505]));

var G__36506 = (i__4830__auto___36505 + (1));
i__4830__auto___36505 = G__36506;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq36474){
var G__36475 = cljs.core.first(seq36474);
var seq36474__$1 = cljs.core.next(seq36474);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36475,seq36474__$1);
}));
...
break;
default:
var G__36508 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__36508;
continue;
...
var n__4706__auto___36509 = a.length;
var i_36510 = (0);
while(true){
if((i_36510 < n__4706__auto___36509)){
(a[i_36510] = reagent.impl.template.as_element((a[i_36510])));

var G__36511 = (i_36510 + (1));
i_36510 = G__36511;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4706__auto___36512 = a.length;
var i_36513 = (0);
while(true){
if((i_36513 < n__4706__auto___36512)){
var val_36514 = (a[i_36513]);
if(((cljs.core.vector_QMARK_(val_36514)) && ((reagent.impl.template.key_from_vec(val_36514) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_36513] = reagent.impl.template.as_element(val_36514));

var G__36516 = (i_36513 + (1));
i_36513 = G__36516;
continue;
} else {
}
...
var ctx = ({});
var vec__36478 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36478,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36478,(1),null);
...
var G__36481 = (cljs.core.count(argv) - first_child);
switch (G__36481) {
case (0):
