...
(def product-detail (lazy-component app.components.product-detail/root))
(def product-listing (lazy-component app.components.product-listing/root))
(def sign-in (lazy-component app.components.sign-in/root))
(def sign-up (lazy-component app.components.sign-up/root))
(def account-overview (lazy-component app.components.account-overview/root))
